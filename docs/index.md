# GetonDigitalJournal IQ — Documentation

**Version:** 1.0.0  
**Author:** GetonDigitalJournal.com  
**Repository:** https://github.com/getondigitaljournal/GetonDigitalJournalIQ  
...
GetonDigitalJournal IQ is an AI-powered content intelligence platform that analyzes publication readiness, predicts AI visibility, and benchmarks successful Digital Journal articles to help improve content quality and discoverability.
...
|----------|-------------|
| ChatGPT | OpenAI ChatGPT citation potential |
| Google AI Overviews | Google SGE and AI Overview presence |
| Perplexity AI | Perplexity AI source citation tracking |
